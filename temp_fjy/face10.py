	...
	while cap.isOpened():
		...
		for i, (x, y, w, h) in enumerate(face_rects):
         ...
         # 置信度评分用来衡量所识别人脸与原模型的差距，0表示完全匹配
			...
			cv2.putText(frame, "person: " + str(id_str[0]), (x+5, y-5), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
			cv2.putText(frame, "Confidence: " + str(confidence), (x+5, y+h-5), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
